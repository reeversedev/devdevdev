    ...
    <div className="newin">
      ...
      <div className="d-flex flex-md-column flex-sm-column highlights">
        <div className="w-50 w-md-100 w-sm-100">
          <div className="category-horizontal-card cyan-background align-items-center text-center font-weight-800 font-size-22 mt-1 m-sm-0 my-sm-2">
            GET UPTO 50% OFF
          </div>
          <div className="category-horizontal-card purple-background mt-1 m-sm-0 my-sm-2">
            <div className="m-2">
